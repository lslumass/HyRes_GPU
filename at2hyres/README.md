...
**Usage:** `python psfgen_hyres.py input_pbd_file output_psf_file terminal_type`, for terminal_type, input 'charged' for charged normal terminus, otherwise leave it blank  
